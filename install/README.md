...
| 命名空间           | 组件名                               | 组件说明                              |
|:---------------|:----------------------------------|:----------------------------------|
| infra          | kubeflow-dashboard-frontend       | modelOne 平台的 Web 前端               |
| infra          | kubeflow-dashboard                | modelOne 平台的 Web 后端               |
| infra          | kubeflow-dashboard-schedule       | 调度 modelOne 平台的系统任务，比如定时清理   |
| infra          | kubeflow-dashboard-worker         | 执行 modelOne 平台的系统任务，比如定时清理   |
| infra          | 	kubeflow-watch                   | 监控 modelOne 平台任务并发起通知和信息更新   |
...
基础环境依赖
 ...
 - 数据库接口地址： mysql，没有可忽略并使用 modelOne 自带的
