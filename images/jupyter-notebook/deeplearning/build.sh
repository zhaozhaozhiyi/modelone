...
cp -R "$modelone_repo_root/aihub/deep-learning/." modelone-examples/

# 构建deeplearning镜像
docker build --build-arg MODELONE_IMAGE_PREFIX="$MODELONE_IMAGE_PREFIX" -t  $hubhost/notebook:jupyter-ubuntu-deeplearning -f Dockerfile .
